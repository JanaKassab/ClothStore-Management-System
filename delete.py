...
def cu_delete():
    ...
    df2 = pd.DataFrame(new_result, columns = ['C_ID','E_ID', 'First_Name','Last Name','Qualification','Address','Locality','City','Email','Phone_NO','DOP','Order_C_ID','Item_ID','Quantity','O_Date','O_Amount','Price'])
